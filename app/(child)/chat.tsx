  ...
  const handleSuggestActivity = () => {
    ...
    if (profile?.id) {
      sendMessage(
        profile.id,
        'text',
        'Hey! I was thinking we could try something new together. What do you think about a video call this weekend? 📱'
      );
    }
  };
      ...
      <View style={styles.header}>
        ...
        {partner && (
          <View style={styles.viewAsContainer}>
            <Text style={styles.viewAsText}>VIEW AS DAD</Text>
          </View>
        )}
      </View>
        ...
        ListEmptyComponent={
          <View style={styles.emptyContainer}>
            <Text style={styles.emptyText}>
              Start a conversation with {partner?.name || 'your parent'}
            </Text>
          </View>
        }
      />
